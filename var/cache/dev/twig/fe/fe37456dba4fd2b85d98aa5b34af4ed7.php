...
class __TwigTemplate_be91718d835ab3b37e981ead85f0d1ac extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin_panel_exercise.html"));
...
<div id=\"content\">
  ...
  <div class=\"videos-list\">
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["categories"]) || array_key_exists("categories", $context) ? $context["categories"] : (function () { throw new RuntimeError('Variable "categories" does not exist.', 343, $this->source); })()));
...
";
    ...
    {
        return array (  500 => 404,  482 => 392,  478 => 391,  474 => 390,  437 => 356,  428 => 350,  424 => 349,  420 => 348,  416 => 347,  412 => 346,  408 => 345,  403 => 344,  399 => 343,  340 => 287,  336 => 286,  332 => 285,  328 => 284,  323 => 282,  40 => 1,);
    }
...
<div id=\"content\">
  ...
  <div class=\"videos-list\">
    ...
    <div class=\"video-item\" data-id=\"{{ video.id }}\">
      ...
      <div class=\"edit-video-form\" style=\"display: none;\">
        <input type=\"text\" class=\"edit-title\" value=\"{{ video.title }}\" />
        <select class=\"edit-category\">
          <option value=\"Οικονομικά (ΑΟΘ)\">Οικονομικά (ΑΟΘ)</option>
          <option value=\"Πληροφορική (ΑΕΠΠ)\">Πληροφορική (ΑΕΠΠ)</option>
          <option value=\"Μαθηματικά\">Μαθηματικά</option>
        ...
        <input type=\"text\" class=\"edit-description\" value=\"{{ video.description }}\" />
        <input type=\"text\" class=\"edit-file-path\" value=\"{{ video.filePath }}\" />
...
", "admin_panel_exercise.html", "/Users/admin/Desktop/panellhnies/panellhnies/templates/admin_panel_exercise.html");
    }
}
